...
for tweet in tweepy.Cursor(api.search,
    ...
    j = tweet._json
    print(j['retweeted_status']['in_reply_to_status_id_str'])

    d[j['retweeted_status']['in_reply_to_status_id_str']] = d.get(j['retweeted_status']['in_reply_to_status_id_str'], 0) + 1
